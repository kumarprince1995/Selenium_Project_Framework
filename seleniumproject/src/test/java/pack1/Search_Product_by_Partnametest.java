...
public class Search_Product_by_Partnametest {
	public static void main(String[] args) throws Throwable {
		...
		String partnodata = row.getCell(4).getStringCellValue();
		driver.findElement(By.name("productname")).sendKeys(productnamedata);
		driver.findElement(By.id("productcode")).sendKeys(partnodata);
		...
		jse.executeScript("arguments[0].value='"+partnodata+"';", searchtext);
		driver.findElement(By.id("bas_searchfield")).click();
		driver.findElement(By.xpath("//select[@id='bas_searchfield']//option[text()='Part Number']")).click();
