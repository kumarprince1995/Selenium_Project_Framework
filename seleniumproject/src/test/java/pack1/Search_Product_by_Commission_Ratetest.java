...
public class Search_Product_by_Commission_Ratetest {
	...
	WebDriver driver=null;
		...
		String commisiondata = row.getCell(6).getStringCellValue();
		driver.findElement(By.name("productname")).sendKeys(productnamedata);
		driver.findElement(By.id("commissionrate")).sendKeys(commisiondata);
		...
		jse.executeScript("arguments[0].value='"+commisiondata+"';", searchtext);
		driver.findElement(By.id("bas_searchfield")).click();
		driver.findElement(By.xpath("//select[@id='bas_searchfield']//option[text()='Commission Rate']")).click();
