...
public class Search_product_by_product_nametest {
...
WebDriver driver=null;
		...
		jse.executeScript("arguments[0].value='"+productnamedata+"';", searchtext);
		driver.findElement(By.id("bas_searchfield")).click();
		driver.findElement(By.xpath("//select[@id='bas_searchfield']//option[text()='Product Name']")).click();
