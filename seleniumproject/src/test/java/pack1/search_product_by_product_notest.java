...
public class search_product_by_product_notest {
	...
	public static void main(String[] args) throws Throwable {
		...
		String productnodata=driver.findElement(By.xpath("//td[text()='Product No']/following-sibling::td[@class='dvtCellInfo']")).getText();
		System.out.println(productnodata);
		driver.findElement(By.linkText("Products")).click();
		WebElement searchtext = driver.findElement(By.xpath("//input[@name='search_text']"));
		JavascriptExecutor jse=(JavascriptExecutor) driver;
		jse.executeScript("arguments[0].value='"+productnodata+"';", searchtext);
		driver.findElement(By.id("bas_searchfield")).click();
		driver.findElement(By.xpath("//select[@id='bas_searchfield']//option[text()='Product No']")).click();
